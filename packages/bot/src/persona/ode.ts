...
import type { CoreDNA } from './data/CoreDNALoader';
import type { PersonaConfig, Phenotype, Stimulus } from './types';
 ...
 */
export function tickPhenotype(prev: Phenotype, dtMs: number, isActive: boolean, config: PersonaConfig): Phenotype {
 ...
 */
export function applyStimulus(prev: Phenotype, stimulus: Stimulus, config: PersonaConfig): Phenotype {
