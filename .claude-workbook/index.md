...
| 2026-04-18 (3) | Avatar Driver Adapter：抽象 `DriverAdapter` (EventEmitter) + VTSDriver（VTS WebSocket API 认证握手 + token 持久化 + InjectParameterDataRequest + 指数退避重连 + 30fps 节流） | src/avatar/drivers/ |
